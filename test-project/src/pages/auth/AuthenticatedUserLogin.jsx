...
function AuthenticatedUserLogin() {
      ...
      <div className="w-full max-w-md space-y-8 p-8 bg-white dark:bg-surface-800 rounded-lg shadow-md">
        ...
        <div className="text-center mt-4">
          <p className="text-sm text-surface-600 dark:text-surface-400">
            ...
            <Link to="/authenticateduser/signup" className="font-medium text-primary hover:text-primary-dark">
              Sign up
            </Link>
          </p>
        </div>
...
export default AuthenticatedUserLogin